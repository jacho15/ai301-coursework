...
I'm a general SWE with production level experience in backend Java/Spring Boot and React in production level setting. However, outside of work, I like working with lower-level systems: C, C++, Verilog, and assembly. I am pretty comfortable with Python as it is my go-to interview language, but I've never used it in a production level codebase, so I'd like to gain more real Python experience. The ranking of my interests is: C++ over Python, and within either, prefer compiler design / low-level systems / CUDA / inference-optimization work over basic AI/ML scaffolding, and prefer both of these languages over anything else.
